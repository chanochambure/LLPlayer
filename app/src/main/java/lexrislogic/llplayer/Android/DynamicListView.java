...
public class DynamicListView extends ListView {
    ...
    private final int SMOOTH_SCROLL_AMOUNT_AT_EDGE = 10;
    ...
    public void setColorAnimation(int color){
        mColor=color;
    }
    ...
    private void updateNeighborViewsForID(long itemID) {
        ...
        PlayListSongAdapter adapter = ((PlayListSongAdapter)getAdapter());
    ...
    private void swapElements(ArrayList<Song> arrayList, int indexOne, int indexTwo) {
        Song temp = arrayList.get(indexOne);
